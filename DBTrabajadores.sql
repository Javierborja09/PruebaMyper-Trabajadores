...
-- 1. Lo primero es verificar si la base de datos ya existe. Si es así, la borramos para empezar desde cero. Hago esto para que no tengan que borrarla a mano cada vez que quieran probar el script y asi asegurar que todo se cree correctamente y sin errores de nombres duplicados.
IF EXISTS (SELECT name FROM sys.databases WHERE name = N'TrabajadoresPrueba')
BEGIN
    -- Terminamos cualquier conexión activa para que permita el borrado
    ALTER DATABASE TrabajadoresPrueba SET SINGLE_USER WITH ROLLBACK IMMEDIATE;
    DROP DATABASE TrabajadoresPrueba;
END
GO

-- 2. Creamos la base de datos desde cero
...
-- 3. Ahora crearemos las tablas que tendra el sistema
...
-- Nota: He puesto 'trabajador.webp' por defecto para que el sistema siempre tenga una imagen
-- Nota tecnica: No se incluyen campos de 'Provincia' ni 'Departamento' por Normalización.
-- Estos datos se obtienen mediante la relación con la tabla 'Distritos'.
CREATE TABLE Trabajadores (
    IdTrabajador INT PRIMARY KEY IDENTITY(1,1),
    -- Un DNI/CE no pasa de 12-15 caracteres. Con 20 sobra y ahorra espacio.
...
INSERT INTO Provincias (IdProvincia, Nombre, IdDepartamento) VALUES 
(101, 'Chachapoyas', 1),
(102, 'Bagua', 1),
(103, 'Bongará', 1),
(104, 'Condorcanqui', 1),
...
INSERT INTO Distritos (IdDistrito, Nombre, IdProvincia) VALUES 
